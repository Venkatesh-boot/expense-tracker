    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-blue-100 to-blue-300">
      <div className="w-full max-w-md bg-white rounded-xl shadow-lg p-8">
        ...
        <div className="flex justify-center mb-6">
          <button
            className={`px-4 py-2 rounded-l-lg border border-blue-400 ${loginMode === 'email' ? 'bg-blue-600 text-white' : 'bg-white text-blue-600'}`}
          ...
          <button
            className={`px-4 py-2 rounded-r-lg border border-blue-400 border-l-0 ${loginMode === 'mobile' ? 'bg-blue-600 text-white' : 'bg-white text-blue-600'}`}
        ...
        {loginMode === 'email' ? (
          ...
          <form onSubmit={handleMobileSubmit(onMobileSubmit)} className="space-y-6">
            ...
            <button type="submit" className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 rounded-lg transition-colors">Send OTP</button>
          </form>
        )}
