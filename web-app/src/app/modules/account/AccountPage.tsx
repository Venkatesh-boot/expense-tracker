  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-2 py-4 sm:px-4 md:px-8">
        <div className="bg-white rounded-lg shadow p-4 sm:p-6 w-full max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl">
          <h2 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 text-blue-700">Account Details</h2>
          ...
          <h3 className="text-base sm:text-lg font-semibold mb-2 text-blue-600">Change Password</h3>
